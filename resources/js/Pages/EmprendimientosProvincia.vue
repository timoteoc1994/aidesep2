<template>
    ...
    <meta
      name="description"
      :content="`Descubre emprendimientos de ${categoriaNormalizada} que fusionan saberes ancestrales y sostenibilidad en la Amazonía ecuatoriana.`"
    />
    <meta
      name="keywords"
      :content="`emprendimientos amazónicos, ${categoriaNormalizada}, sostenibilidad, saberes ancestrales, Ecuador`"
    />
    ...
    <meta
      ...
      :content="`Explora proyectos innovadores de ${categoriaNormalizada} que protegen la Amazonía y promueven cultura y desarrollo sostenible.`"
    />
    <meta property="og:type" content="website" />
    <meta
      property="og:url"
      :content="`https://conamazonia.com/emprendimientosProvincia/${props.codigo}`"
    />
    <meta
      property="og:image"
    ...
    <meta
      ...
      :content="`Conoce los emprendimientos de ${categoriaNormalizada} que impulsan un futuro sostenible desde la Amazonía ecuatoriana.`"
    />
    <meta
      name="twitter:image"
      content="https://conamazonia.com/images/conAmazonia/Patrones.webp"
    ...
    <link
      rel="canonical"
      :href="`https://conamazonia.com/emprendimientosProvincia/${props.codigo}`"
    />
  </Head>
...
const categoriaNormalizada = computed(() => {
    return provinciasEcuador[props.codigo] || 'Provincia desconocida';
});
...
const cargarFiltros = async () => {
    try {
        const { data } = await axios.get(`/api/filtros/provincia/${props.codigo}`);
...
const obtenerEmprendimientos = async (pagina = paginacion.value.current_page) => {
    ...
    try {
        ...
        const { data } = await axios.get(`/api/emprendimientos/provincia/${props.codigo}`, { params });
