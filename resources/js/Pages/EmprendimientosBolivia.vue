<template>
  ...
  <meta
    name="description"
    content="Descubre proyectos amazónicos de {{ categoriaNormalizada }} que combinan tradición, sostenibilidad e innovación en Amazon Fair Trade."
  />
  <meta
    name="keywords"
    content="Emprendimientos, Amazonía Boliviana, {{ categoriaNormalizada }}, Amazon Fair Trade, tradición, sostenibilidad, innovación"
  />
  ...
  <meta
    ...
    content="Explora proyectos amazónicos de {{ categoriaNormalizada }} que impulsan economía indígena y conservación en la Amazonía boliviana."
  />
  <meta property="og:type" content="website" />
  <meta
    property="og:url"
    content="https://amazonfairtrade.org/emprendimientosBolivia/{{ props.categoria }}"
  />
  <meta
    property="og:image"
  ...
  <meta
    ...
    content="Conoce los emprendimientos de {{ categoriaNormalizada }} en la Amazonía boliviana: tradición, sostenibilidad e innovación."
  />
  <meta
    name="twitter:image"
    content="https://amazonfairtrade.org/images/amazonFairTrade/FondoIA.webp"
  ...
  <link
    rel="canonical"
    href="https://amazonfairtrade.org/emprendimientosBolivia/{{ props.categoria }}"
  />
</Head>
    ...
    <section class="py-16 px-6 md:px-12 lg:px-20 bg-[#0D6734]">
        <div class="w-full mx-auto">
            ...
            <div class="mb-12 text-center relative">
                ...
                <p class="text-lg text-[#FBF8F3]/90 max-w-2xl mx-auto">
                    ...
                    <div class="bg-[#FFF8EA] p-4 rounded-lg sticky top-4 border-2 border-[#AB8219]">
                        <div class="mb-4 flex justify-between items-center">
                            ...
                            <button
                                ...
                                @click="resetearFiltros" class="text-xs text-[#AB8219] hover:text-[#124228]">
                                Resetear filtros
                            </button>
                        </div>
                    ...
                    <div class="relative mb-6 flex items-center gap-2">
                        <div class="relative flex-1 group">
                            ...
                            <input v-model="busqueda" @input="handleBusqueda" type="text"
                                class=" bg-[#FBF8F3] w-full pl-12 text-[#374151] font-bold border-2 border-[#AB8219] rounded-lg focus:outline-none focus:ring-0 focus:border-[#AB8219]"
...
const obtenerFiltros = async () => {
    try {
        const response = await axios.get(`/api/filtros/categoria-bolivia/${props.categoria}`);
...
const obtenerEmprendimientos = async (pagina = 1) => {
    cargando.value = true;
    try {
        const response = await axios.get(`/api/emprendimientos/categoria-bolivia/${props.categoria}`, {
            params: {
                page: pagina,
