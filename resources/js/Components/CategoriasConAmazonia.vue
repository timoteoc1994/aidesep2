<template>
    <section id="categorias" class="bg-white py-20 px-6 md:px-12 lg:px-20 text-gray-800 relative">
        <div class="max-w-6xl mx-auto">
            <div data-aos="zoom-in" data-aos-delay="100" class="inline-block mb-12 text-center w-full">
                <h2 class="text-3xl md:text-4xl font-extrabold mb-3 leading-tight text-emerald-900">
                    Categorías de productos
                </h2>
                <div class="h-1 w-24 bg-emerald-600 rounded-full mx-auto"></div>
...
const navegarACategoriaEcuador = (categoria) => {
    ...
    if (categoria && typeof categoria === 'object' && categoria.slug) {
        ...
        inertiaRouter.visit(`/emprendimientosPaises/${slug}`);
    } else {
